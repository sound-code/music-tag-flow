...
class UIService extends ServiceBase {
    ...
    /**
     * Setup legend event listeners - DISABLED - handled by legacy ui.js
     */
    setupLegendEventListeners() {
        // DISABLED: Legend event handling is done by legacy ui.js to avoid duplication
        // This prevents double event listeners and duplicate popups
    }

    /**
     * Setup event listeners for a legend item
     * @param {HTMLElement} item - Legend item element
     */
    setupLegendItemListeners(item) {
        ...
        item.addEventListener('mousemove', (e) => {
            if (this.elements.legendPopup.style.display === 'block') {
